...
# ==========================================
MAX_GRAPH_POINTS = 300  # Rolling buffer (~15-30s window depending on packet rate)

# Graph 1: Altitude & Pressure
graph_alt = graph(
    title="<b>Barometric Altitude (m)</b>",
    xtitle="Flight Time (s)", ytitle="Altitude (m)",
    width=490, height=220, align="left", background=color.gray(0.12)
)
...
graph_accel = graph(
    ...
    width=490, height=220, align="right", background=color.gray(0.12)
)
